...
from .service import TrainingPlanActionService


service = TrainingPlanActionService()
schema = TrainingPlanActionSchema()
...
def apply_ai_actions(payload: Dict[str, Any]):
    try:
        result = service.apply_ai_actions(payload)
